...
- 在线版（持续更新、含完整书系）：[inferloop.dev](https://inferloop.dev)
- 源码仓库：[github.com/inferloop/llm-infra-book](https://github.com/inferloop/llm-infra-book)（如暂未公开，可先以在线版为准；勘误和问题请通过仓库 Issues 提交）
